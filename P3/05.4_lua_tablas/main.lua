...
mapa = {
    { name = "dragon", position = { x = 100, y = 100 } },
    { name = "dragon", position = { x = 250, y = 100 } },
    { name = "dragon", position = { x = 400, y = 100 } },
    { name = "mago",   position = { x = 150, y = 250 } },
    { name = "mago",   position = { x = 300, y = 250 } },
    { name = "grunt",  position = { x = 200, y = 400 } },
    { name = "grunt",  position = { x = 350, y = 400 } },
    { name = "grifo",  position = { x = 500, y = 350 } },
    { name = "peon",   position = { x = 600, y = 300 } },
}
